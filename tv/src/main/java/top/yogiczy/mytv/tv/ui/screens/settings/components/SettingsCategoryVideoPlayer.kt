...
fun SettingsCategoryVideoPlayer(
    ...
    SettingsContentList(modifier) {
        ...
        item {
            SettingsListItem(
                headlineContent = "強制軟解",
                supportingContent = "對於Media3，使音頻強制軟解\n對於IJK，將禁用MediaCodec解碼（使用ffmpeg）",
                trailingContent = {
        ...
        item {
            ...
            SettingsListItem(
                ...
                headlineContent = "播放器加載超時",
                supportingContent = "影響超時換源、斷線重連",
